...
public class Rotation3d {
    ...
    public Rotation3d(double roll, double pitch, double yaw) {
        q = MathUtil.eulerToQuaternion(roll, pitch, yaw);
    }
    ...
    public double getX() {
        return MathUtil.quaternionToEuler(q).getRoll();
    }

    public double getY() {
        return MathUtil.quaternionToEuler(q).getPitch();
    }

    public double getZ() {
        return MathUtil.quaternionToEuler(q).getYaw();
    }
