...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 10.05; // in
...
//    public static double kA = 00.004;
//    public static double kStatic = 0.02;
    ...
    public static double MAX_ANG_VEL = Math.toRadians(330);
    public static double MAX_ANG_ACCEL = Math.toRadians(330);
