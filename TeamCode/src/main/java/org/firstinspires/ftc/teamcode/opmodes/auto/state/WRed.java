...
public class WRed extends BaseOpMode {
    ...
    public void initialize() {
        ...
        driveSS.setDwPose(AutoConstantsState.RedW.START);
...
//        proppos = 3;
        ...
        if (gamepad1.x && !pastX) {
            visionPortal.saveNextFrameRaw(String.format(Locale.US, "CameraFrameCaptureRedW-%06d", System.currentTimeMillis()));
        }
        pastX = gamepad1.x;
    ...
    public void runOnce() {
        switch (proppos) {
            case (1):
                purplePose = AutoConstantsState.RedW.SPIKE_1;
                prePurplePose = AutoConstantsState.RedW.SPIKE_1_PREP;
                offPurplePose = AutoConstantsState.RedW.SPIKE_1_BACK;
                stackAlignedPose = AutoConstantsState.RedW.STACK_ALIGN_1;
                stackPose = AutoConstantsState.RedW.STACK_1;
                crossFieldPose = AutoConstantsState.RedW.INTERMEDIAN;
                backdropAlignPose1 = AutoConstantsState.RedW.BD_1_OFF;
                backdropAlignPose2 = AutoConstantsState.RedW.BD_2_OFF;
                backdropAlignPose3 = AutoConstantsState.RedW.BD_3_OFF;
                backdrop1Pose = AutoConstantsState.RedW.BD_1;
                backdrop2Pose = AutoConstantsState.RedW.BD_2;
                backdrop3Pose = AutoConstantsState.RedW.BD_3;
                parkPose = AutoConstantsState.RedW.PARK;
                ...
                break;
            case (2):
                purplePose = AutoConstantsState.RedW.SPIKE_2;
                prePurplePose = AutoConstantsState.RedW.SPIKE_2_PREP;
                offPurplePose = AutoConstantsState.RedW.SPIKE_2_BACK;
                stackAlignedPose = AutoConstantsState.RedW.STACK_ALIGN_2;
                stackPose = AutoConstantsState.RedW.STACK_2;
                crossFieldPose = AutoConstantsState.RedW.INTERMEDIAN;
                backdropAlignPose1 = AutoConstantsState.RedW.BD_2_OFF;
                backdropAlignPose2 = AutoConstantsState.RedW.BD_1_OFF;
                backdropAlignPose3 = AutoConstantsState.RedW.BD_3_OFF;
                backdrop1Pose = AutoConstantsState.RedW.BD_2;
                backdrop2Pose = AutoConstantsState.RedW.BD_1;
                backdrop3Pose = AutoConstantsState.RedW.BD_3;
                parkPose = AutoConstantsState.RedW.PARK;
                pivot = new InstantCommand(() -> armSS.pivotRotatedState = ArmSubsystem.PivotRotatedState.NORMAL);
                slowSpeed = 0.75;
                ...
                break;
            case (3):
                purplePose = AutoConstantsState.RedW.SPIKE_3;
                prePurplePose = AutoConstantsState.RedW.SPIKE_3_PREP;
                offPurplePose = AutoConstantsState.RedW.SPIKE_3_BACK;
                stackAlignedPose = AutoConstantsState.RedW.STACK_ALIGN_3;
                stackPose = AutoConstantsState.RedW.STACK_3;
                crossFieldPose = AutoConstantsState.RedW.INTERMEDIAN;
                backdropAlignPose1 = AutoConstantsState.RedW.BD_3_OFF;
                backdropAlignPose2 = AutoConstantsState.RedW.BD_1_OFF;
                backdropAlignPose3 = AutoConstantsState.RedW.BD_2_OFF;
                backdrop1Pose = AutoConstantsState.RedW.BD_3;
                backdrop2Pose = AutoConstantsState.RedW.BD_1;
                backdrop3Pose = AutoConstantsState.RedW.BD_2;
                parkPose = AutoConstantsState.RedW.PARK;
        ...
        prePurple = new PIDToPoint(driveSS, prePurplePose, 1, 5);
        ...
        schedule(new SequentialCommandGroup(
                ...
                new PIDToPointSpeed(driveSS, prePurplePose, 1.25, defaultHeadingTol, slowSpeed).withTimeout(2500),
                new PIDToPoint(driveSS, purplePose, 1.25, defaultHeadingTol).withTimeout(2000),
...
//                ),
                ...
                new ParallelCommandGroup(
                        ...
                        new WaitCommand(100),
                        pivot,
                        new SetElevatorPowerForTime(eleSS, -1, 175)
                ),
