...
public class WBlueTest extends BaseOpMode {
    ...
    private SequentialCommandGroup cycleBackdrop1;
    private SequentialCommandGroup cycleBackdrop2;
    private SequentialCommandGroup cycleBackdrop3;
    private SequentialCommandGroup cycleBackstage;
...
//        proppos = propProcessor.getSpike();
    ...
    public void runOnce() {
        ...
        placePurple = new SequentialCommandGroup(
                purple,
                offPurple
        );

        cycleBackdrop1 = new SequentialCommandGroup(
                stackAligned, stack
        );
