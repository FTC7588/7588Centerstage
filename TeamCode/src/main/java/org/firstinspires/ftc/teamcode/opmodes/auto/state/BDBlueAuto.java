...
@Config
@Autonomous
public class BDBlueAuto extends BaseOpMode {
    ...
    public void initialize() {
        ...
        driveSS.setDwPose(AutoConstantsState.BlueBD.START);
...
//        proppos = 3;
        ...
        if (gamepad1.x && !pastX) {
            visionPortal.saveNextFrameRaw(String.format(Locale.US, "CameraFrameCaptureBlueBD-%06d", System.currentTimeMillis()));
        }
        pastX = gamepad1.x;
    ...
    public void runOnce() {
        switch (proppos) {
            case (1):
                purplePose = AutoConstantsState.BlueBD.SPIKE_1;
                prePurplePose = AutoConstantsState.BlueBD.SPIKE_1_PREP;
                offPurplePose = AutoConstantsState.BlueBD.SPIKE_1_BACK;
                stackAlignedPose = AutoConstantsState.BlueBD.STACK_ALIGNED;
                stackPose = AutoConstantsState.BlueBD.STACK;
                crossFieldPoseBD = AutoConstantsState.BlueBD.CROSS_FIELD_BD;
                crossFieldPoseW = AutoConstantsState.BlueBD.CROSS_FIELD_W;
                backdropAlignPose1 = AutoConstantsState.BlueBD.BD_1_OFF;
                backdropAlignPose2 = AutoConstantsState.BlueBD.BD_3_OFF;
                backdropAlignPose3 = AutoConstantsState.BlueBD.BD_2_OFF;
                backdrop1Pose = AutoConstantsState.BlueBD.BD_1;
                backdrop2Pose = AutoConstantsState.BlueBD.BD_3;
                backdrop3Pose = AutoConstantsState.BlueBD.BD_2;
                parkPose = AutoConstantsState.BlueBD.PARK;
                ...
                break;
            case (2):
                purplePose = AutoConstantsState.BlueBD.SPIKE_2;
                prePurplePose = AutoConstantsState.BlueBD.SPIKE_2_PREP;
                offPurplePose = AutoConstantsState.BlueBD.SPIKE_2_BACK;
                stackAlignedPose = AutoConstantsState.BlueBD.STACK_ALIGNED;
                stackPose = AutoConstantsState.BlueBD.STACK;
                crossFieldPoseBD = AutoConstantsState.BlueBD.CROSS_FIELD_BD;
                crossFieldPoseW = AutoConstantsState.BlueBD.CROSS_FIELD_W;
                backdropAlignPose1 = AutoConstantsState.BlueBD.BD_2_OFF;
                backdropAlignPose2 = AutoConstantsState.BlueBD.BD_1_OFF;
                backdropAlignPose3 = AutoConstantsState.BlueBD.BD_3_OFF;
                backdrop1Pose = AutoConstantsState.BlueBD.BD_2;
                backdrop2Pose = AutoConstantsState.BlueBD.BD_1;
                backdrop3Pose = AutoConstantsState.BlueBD.BD_3;
                parkPose = AutoConstantsState.BlueBD.PARK;
                pivot = new InstantCommand(() -> armSS.pivotRotatedState = ArmSubsystem.PivotRotatedState.NORMAL);
                slowSpeed = 0.75;
                xOffset = 0;
                ...
                break;
            case (3):
                purplePose = AutoConstantsState.BlueBD.SPIKE_3;
                prePurplePose = AutoConstantsState.BlueBD.SPIKE_3_PREP;
                offPurplePose = AutoConstantsState.BlueBD.SPIKE_3_BACK;
                stackAlignedPose = AutoConstantsState.BlueBD.STACK_ALIGNED;
                stackPose = AutoConstantsState.BlueBD.STACK;
                crossFieldPoseBD = AutoConstantsState.BlueBD.CROSS_FIELD_BD;
                crossFieldPoseW = AutoConstantsState.BlueBD.CROSS_FIELD_W;
                backdropAlignPose1 = AutoConstantsState.BlueBD.BD_3_OFF;
                backdropAlignPose2 = AutoConstantsState.BlueBD.BD_1_OFF;
                backdropAlignPose3 = AutoConstantsState.BlueBD.BD_2_OFF;
                backdrop1Pose = AutoConstantsState.BlueBD.BD_3;
                backdrop2Pose = AutoConstantsState.BlueBD.BD_1;
                backdrop3Pose = AutoConstantsState.BlueBD.BD_2;
                parkPose = AutoConstantsState.BlueBD.PARK;
