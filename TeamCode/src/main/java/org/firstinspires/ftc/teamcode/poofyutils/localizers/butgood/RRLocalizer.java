...
public class RRLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -5.492; // X is the up and down direction
    public static double PARALLEL_Y = -2.588; // Y is the strafe direction

    public static double PERPENDICULAR_X = -4.569;
